...
%初始化
clear all;
C=[1304 2312;3639 1315;4117 2244;3712 1399;3488 1535;3326 1556;3238 1229;...
   4196 1004 ; 4312 790;4386 570;3007 1970;2562 1756;2788 1491;2381 1676;...
   1332 695;3715 1678;3918 2179;4061 2370;3780 2212;3676 2578;4029 2833;...
   4263 2931;3429 1908;3507 2367; 3394 2643;3439 3201;2935 3240;3140 3550;...
   2545 2357;2778 2826;2370 2975];  %31个省会城市坐标
...
figure;
for i=1:N-1
    plot([C(Bestf(i),1),C(Bestf(i+1),1)],[C(Bestf(i),2),C(Bestf(i+1),2)],'k-+');
    hold on;
end
for i=1:N-1
    plot([C(Bestf(N),1),C(Bestf(1),1)],[C(Bestf(N),2),C(Bestf(1),2)],'k-+');
    hold on;
end
