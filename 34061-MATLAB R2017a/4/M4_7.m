...
figure(2)
plot(1:10,accuracy(1,:),'r-*',1:10,accuracy(2,:),'r:o')
grid on
xlabel('模型编号');ylabel('测试集正确率')
title('10个模型的测试集正确率对比(GRNN vs PNN)')
legend('GRNN网络','PNN网络')
figure(3)
plot(1:10,time(1,:),'r-*',1:10,time(2,:),'r:o')
grid on
xlabel('模型编号');ylabel('运行时间(s)')
